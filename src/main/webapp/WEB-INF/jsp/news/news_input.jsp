...
<div class="sessionWin active">  
	<div class="sessionHeader clearfix">  
		...
		<a  class="pullLeft sessionHeader-name" target="_blank">胡蝶</a>  
	</div> 
	<div class="chat"> 
	<!--聊天窗口-->
		<div class="msgPanel"> 
