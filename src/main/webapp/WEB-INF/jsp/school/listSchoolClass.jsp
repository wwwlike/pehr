          ...
          <section class="hbox stretch">
            <aside class="aside-md bg-white b-r" id="subNav">
              ...
              <ul class="nav nav-pills nav-stacked no-radius">
                ...
                <li class="b-b b-light ${school.id==bean.id?'active':''} "><a href="/school/listSchoolClass?id=${school.id}">
                ...
                <header class="header bg-white b-b clearfix">
                  <div class="row m-t-sm">
                    <div class="col-sm-8 m-b-xs">
                      ...
                      <a href="modal.html" data-toggle="ajaxModal" class="btn btn-sm btn-default"><i class="fa fa-plus"></i> 新建班级</a>
                    </div>
...
//iframe层
	  layer.open({
	    ...
	    shade: 0.8,
	    area: ['800px', '60%'],
	    content: '/school/input' //iframe的url
	  }); 
  }
  </script>
  <!-- 
